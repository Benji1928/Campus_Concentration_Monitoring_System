"""
Train MLP classifier — V2 Configuration.

V2: 3-layer [256, 128, 64], tanh, SGD + adaptive LR + Nesterov momentum.

Usage (from project root):
    python src/classifiers/landmark_pipeline/train_evaluate_v2.py

Outputs (models/MLP_V2/):
